        ...
        public function store(Request $request)
        {
            ...
            if ($validator->fails()) {
                ...
                $book->save();
                 ...
                 $author1=DB::table('authors')->where('name', $inputs['author1'])->value('id');
                $author2=DB::table('authors')->where('name', $inputs['author2'])->value('id');
                $author3=DB::table('authors')->where('name', $inputs['author3'])->value('id');
                ...
                if (isset($author3)) {
                    if (strlen($author3) > 0) {
                        $book->authors()->attach($author3);
                    }
                }
                $category1=DB::table('categories')->where('title', $inputs['category1'])->value('id');
                $category2=DB::table('categories')->where('title', $inputs['category2'])->value('id');
                $category3=DB::table('categories')->where('title', $inputs['category3'])->value('id');
                $book->categories()->attach($category1);
                if (isset($category2)) {
                    if (strlen($category2) > 0) {
                        $book->categories()->attach($category2);
                    }
                }
                if (isset($category3)) {
                    if (strlen($category3) > 0) {
                        $book->categories()->attach($category3);
                    }
                }
