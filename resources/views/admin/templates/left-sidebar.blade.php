<aside class="main-sidebar">
    ...
    <!-- /.search form -->
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-book"></i> <span>Books</span> <i
                            class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li class="">
                        <a href="/admin/book/add-new"><i class="fa fa-plus"></i>Add New Book</a>
                    </li>
                    <li class="{{ Request::is('admin/book/list') ? 'active' : '' }}">
                        <a href="/admin/book/list"><i class="fa fa-book"></i> Book List</a>
                    </li>
